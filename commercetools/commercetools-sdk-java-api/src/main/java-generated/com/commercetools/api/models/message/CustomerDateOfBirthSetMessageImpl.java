...
public class CustomerDateOfBirthSetMessageImpl implements CustomerDateOfBirthSetMessage, ModelBase {
    ...
    @JsonCreator
    CustomerDateOfBirthSetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
    ...
    */
    ...
    public boolean equals(Object o) {
        ...
        CustomerDateOfBirthSetMessageImpl that = (CustomerDateOfBirthSetMessageImpl) o;
