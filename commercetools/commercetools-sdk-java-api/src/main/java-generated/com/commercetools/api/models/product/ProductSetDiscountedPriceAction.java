...
/**
 *  <p>Produces the ProductPriceExternalDiscountSetMessage.</p>
 *
 * <hr>
...
public interface ProductSetDiscountedPriceAction extends ProductUpdateAction {
    ...
    /**
     *  <p>Value to set. The referenced ProductDiscount must have the Type <code>external</code>, be active, and its predicate must match the referenced Price.</p>
     */
    @Valid
