...
public class MessageImpl implements Message, ModelBase {
    ...
    @JsonCreator
    MessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
            ...
            @JsonProperty("resourceVersion") final Long resourceVersion, @JsonProperty("type") final String type,
