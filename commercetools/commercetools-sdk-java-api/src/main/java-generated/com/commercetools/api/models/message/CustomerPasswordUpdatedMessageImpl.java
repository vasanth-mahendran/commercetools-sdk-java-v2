...
public class CustomerPasswordUpdatedMessageImpl implements CustomerPasswordUpdatedMessage, ModelBase {
    ...
    CustomerPasswordUpdatedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
            ...
            @JsonProperty("reset") final Boolean reset) {
        this.id = id;
    ...
    */
    ...
    public boolean equals(Object o) {
        ...
        CustomerPasswordUpdatedMessageImpl that = (CustomerPasswordUpdatedMessageImpl) o;
