...
public class PaymentTransactionAddedMessageImpl implements PaymentTransactionAddedMessage, ModelBase {
    ...
    @JsonCreator
    PaymentTransactionAddedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
    ...
    */
    ...
    public boolean equals(Object o) {
        ...
        PaymentTransactionAddedMessageImpl that = (PaymentTransactionAddedMessageImpl) o;
