...
public class OrderStoreSetMessageImpl implements OrderStoreSetMessage, ModelBase {
    ...
    @JsonCreator
    OrderStoreSetMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
    ...
    */
    ...
    public boolean equals(Object o) {
        ...
        OrderStoreSetMessageImpl that = (OrderStoreSetMessageImpl) o;
