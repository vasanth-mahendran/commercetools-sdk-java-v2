...
public interface ShippingRateTierType {
    ...
    /**
    	<p>Used when the ShippingRate maps to the sum of <a href="ctp:api:type:LineItem">LineItem</a> Prices. The value of the Cart is used to select a tier. If chosen, it is not possible to set a value for the <code>shippingRateInput</code> on the <a href="ctp:api:type:Cart">Cart</a>. Tiers contain the <code>centAmount</code> (a value of <code>100</code> in the currency <code>USD</code> corresponds to <code>$ 1.00</code>), and start at <code>1</code>.'</p>

    */
    ShippingRateTierType CART_VALUE = ShippingRateTierTypeEnum.CART_VALUE;
    /**
    	<p>Used when the ShippingRate maps to an abstract Cart categorization expressed by strings (for example, <code>Light</code>, <code>Medium</code>, or <code>Heavy</code>). Only keys defined in the <code>values</code> array can be used to create a tier or to set a value of the <code>shippingRateInput</code> on the <a href="ctp:api:type:Cart">Cart</a>. Keys must be unique.</p>

    */
    ShippingRateTierType CART_CLASSIFICATION = ShippingRateTierTypeEnum.CART_CLASSIFICATION;
    /**
    	<p>Used when the ShippingRate maps to an abstract Cart categorization expressed by integers (such as shipping scores or weight ranges). The range starts at <code>0</code>. The default price covers <code>0</code>, tiers start at <code>1</code>.</p>
