...
public class OrderCreatedMessageImpl implements OrderCreatedMessage, ModelBase {
    ...
    @JsonCreator
    OrderCreatedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
    ...
    */
    ...
    public boolean equals(Object o) {
        ...
        OrderCreatedMessageImpl that = (OrderCreatedMessageImpl) o;
