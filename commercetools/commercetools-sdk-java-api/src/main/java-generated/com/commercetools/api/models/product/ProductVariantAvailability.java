...
/**
 *  <p>The InventoryEntry information of the ProductVariant. If there is a supply Channel for the InventoryEntry, then <code>channels</code> is returned. If not, then <code>isOnStock</code>, <code>restockableInDays</code>, and <code>quantityOnStock</code> are returned.</p>
 *
 * <hr>
...
public interface ProductVariantAvailability {
    ...
    /**
     *  <p>Indicates whether a ProductVariant is in stock.</p>
     */
    ...
    /**
     *  <p>Number of days to restock a ProductVariant once it is out of stock.</p>
     */
    ...
    /**
     *  <p>Number of items of the ProductVariant that are in stock.</p>
     */
