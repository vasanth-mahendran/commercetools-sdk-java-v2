...
public class ReviewCreatedMessageImpl implements ReviewCreatedMessage, ModelBase {
    ...
    ReviewCreatedMessageImpl(@JsonProperty("id") final String id, @JsonProperty("version") final Long version,
            ...
            @JsonProperty("review") final com.commercetools.api.models.review.Review review) {
        this.id = id;
    ...
    */
    ...
    public boolean equals(Object o) {
        ...
        ReviewCreatedMessageImpl that = (ReviewCreatedMessageImpl) o;
